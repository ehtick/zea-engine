...
* The GLRenderer now supports various rendermodes that configure 'wireframe', 'hidden line', 'flat' and 'pbr' render styles. ([3ae4fb0](https://github.com/ZeaInc/zea-engine/commit/3ae4fb09021dfe3ba984ee3687773df18c5bdd48))
...
* TreeItem now features an opacityParam which provides a hierarchical opacity setting. ([d22a957](https://github.com/ZeaInc/zea-engine/commit/d22a9571cc719208453f527210d000adea87d946))
* The renderer can now release Geometry data to free up memory after uploading it to the GPU  ([c04cef5](https://github.com/ZeaInc/zea-engine/commit/c04cef598424c971777722a7da04ae8425b8ab59))
...
* Viewport no longer emits a 'pointerDoublePressed' event when using multiple touches. ([846cacd](https://github.com/ZeaInc/zea-engine/commit/846cacd56f0ce11669f9d358c9e72d2595e5aa5f))
