...
- [`EventEmitter`](../../Utilities/Utilities_EventEmitter.EventEmitter)
  ...
  ↳↳ [`CompoundGeom`](SceneTree_Geometry_CompoundGeom.CompoundGeom)
...
[src/SceneTree/Geometry/GeomProxies.ts:21](https://github.com/ZeaInc/zea-engine/blob/bfc726cd6/src/SceneTree/Geometry/GeomProxies.ts#L21)
