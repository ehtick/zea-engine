...
- [`BaseClass`](Utilities_BaseClass.BaseClass)
  ...
  ↳↳ [`GLGeomItemSetMultiDrawCompoundGeom`](../Renderer/Drawing/Renderer_Drawing_GLGeomItemSetMultiDrawCompoundGeom.GLGeomItemSetMultiDrawCompoundGeom)
  ...
  ↳↳ [`WorkerPool`](Utilities_WorkerPool.WorkerPool)
...
[src/Utilities/EventEmitter.ts:33](https://github.com/ZeaInc/zea-engine/blob/8e646f8a8/src/Utilities/EventEmitter.ts#L33)
