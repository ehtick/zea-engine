...
[src/Renderer/Shaders/ConvolveIrradianceShader.ts:20](https://github.com/ZeaInc/zea-engine/blob/819769315/src/Renderer/Shaders/ConvolveIrradianceShader.ts#L20)
