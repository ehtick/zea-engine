...
[src/Renderer/Shaders/ConvolveSpecularShader.ts:20](https://github.com/ZeaInc/zea-engine/blob/819769315/src/Renderer/Shaders/ConvolveSpecularShader.ts#L20)
