...
- [`GLBaseViewport`](../Renderer_GLBaseViewport.GLBaseViewport)
  ...
  ↳↳ [`ARViewport`](Renderer_VR_ARViewport.ARViewport)

  ↳↳ [`VRViewport`](Renderer_VR_VRViewport.VRViewport)

## Constructors

### constructor

• **new XRViewport**(`renderer`, `sessionMode`)
...
[src/Renderer/VR/XRViewport.ts:48](https://github.com/ZeaInc/zea-engine/blob/bfc726cd6/src/Renderer/VR/XRViewport.ts#L48)
...
▸ `Abstract` **drawXRFrame**(`xrFrame`): `void`
...
[src/Renderer/VR/XRViewport.ts:177](https://github.com/ZeaInc/zea-engine/blob/bfc726cd6/src/Renderer/VR/XRViewport.ts#L177)
...
[src/Renderer/VR/XRViewport.ts:135](https://github.com/ZeaInc/zea-engine/blob/bfc726cd6/src/Renderer/VR/XRViewport.ts#L135)
